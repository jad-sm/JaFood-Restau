...
Deuxième version du site JaFood : menu professionnel en anglais par défaut, traduction française instantanée, produits classés dans leur catégorie exacte et réservation WhatsApp active.

## Coordonnées configurées

- WhatsApp et téléphone : `+961 76 545 146`
- Adresse : Hamra, derrière le restaurant Em Sherif, Beyrouth, Liban
- Réservations : le formulaire prépare un message complet et l'ouvre directement dans WhatsApp vers le numéro ci-dessus.
...
## Configuration actuelle des réservations

Le numéro WhatsApp est déjà activé dans `script.js` :
...
Pour modifier le destinataire plus tard, remplacez simplement le numéro international, sans `+`, espaces ou tirets.

### Alternative avec Formspree
...
Le menu présent dans `index.html` est une proposition complète créée pour JaFood. Vérifiez et ajustez les prix avant l'ouverture commerciale.
